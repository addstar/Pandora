...
public class LobbyProtection implements Module, Listener {
    ...
    public void onInventoryDrag(InventoryDragEvent e) {
        ...
        if (!p.hasPermission("pandora.invlock.bypass") && (opts != null) && (opts.inventoryLock)) {
            if (Debug)
                mPlugin.getLogger().info("[LobbyProtection] Cancelling InventoryDragEvent for " + e.getWhoClicked().getName());
            e.setCancelled(true);
        }
    }
    ...
    public void onInventoryClick(InventoryClickEvent e) {
        ...
        if (!p.hasPermission("pandora.invlock.bypass") && (opts != null) && (opts.inventoryLock)) {
            if (Debug)
                mPlugin.getLogger().info("[LobbyProtection] Cancelling InventoryClickEvent for " + e.getWhoClicked().getName());
            e.setCancelled(true);
        }
    }
}